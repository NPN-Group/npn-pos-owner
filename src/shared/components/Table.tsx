...
export default function Tablecomponent({ Tables, isActive, onClick }: TableProps) {
  return (
    <div className='h-[150px] w-[150px] flex flex-col items-center group'>
      <div className="h-[150px] w-[150px] rounded-full flex items-center justify-center text-white text-lg  ">
        <div
          className={`relative w-[105px] h-[105px] bg-cover bg-center rounded-full border-2 transition-all duration-300 hover:cursor-pointer ${isActive
            ? "border-red-500"
